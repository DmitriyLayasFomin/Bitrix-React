            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-header">
                        <h4 className="modal-title">Условия оферты</h4>
                        <button onClick={()=>{this.props.showHide("oferta");}} type="button" className="close" data-dismiss="modal"><img src={cancel} alt="/" className="close-img"/></button>
                    </div>
                    {/*<!-- Modal body -->*/}
