...
class Politic extends React.Component {
    ...
    render() {
        return (
            ...
            <div className={this.state.modalClass} id="myModal5">
                <div className="modal-dialog">
                    <div className="modal-content">
                        {/*<!-- Modal Header -->*/}
                        <div className="modal-header">
                            <h4 className="modal-title">Политека конфиденциальности</h4>
                            <button onClick={()=>{this.props.showHide("politic");}} type="button" className="close" data-dismiss="modal"><img src={cancel} alt="/" className="close-img"/></button>
                        </div>
                         {/*<!-- Modal body -->*/}
