...
class Footer extends React.Component {
    ...
    render() {
        ...
        return (
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 col-md-3">
                            <a href="index.html">
                                <img src={logo} alt="logo" className="logo logo_bottom"/>
                            </a>
                            <br/>
                            <a onClick={() => {
                                this.switchPopup('soglasie');
                            }} className="footer-left_a" href={"#"}>Пользовательское соглашение</a><br/>
                            <a onClick={() => {
                                this.switchPopup('politic');
                            }} className="footer-left_a" href={"#"}>Политека конфидинсальности</a><br/>
                            <a onClick={() => {
                                this.switchPopup('oferta');
                            }} className="footer-left_a" href={"#"}>Условия офферта</a>
                        </div>
                        <div className="col-lg-3 col-md-3">
                            <p className="footer_h">Карта сайта</p>
                        ...
                        <div className="col-lg-3 col-md-3">
                            <p className="footer_h">Социальные сети</p>
                            <a href="#" className="footer_a">
                                <svg version="1.1" className="footer_a_img" xmlns="http://www.w3.org/2000/svg"
                                     xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"
			...
			C307.556,0.033,306.489,0,304.994,0c-12.088,0-54.123,2.385-87.472,33.064c-36.401,33.493-32.918,73.557-31.386,83.435v48.84h-46.371c-9.995,0-18.128,8.132-18.128,18.128v80.629c0,9.997,8.132,18.13,18.128,18.13h43.688v211.647c0,9.995,8.132,18.128,18.128,18.128h91.368c9.995,0,18.128-8.133,18.128-18.128V283.271h51.749
			...
			h-61.156v-40.997C311.079,115.872,313.39,111.282,325.581,111.282z M300.881,185.739h68.807l-8.886,77.134h-59.924c-5.632,0-10.199,4.566-10.199,10.199v218.53H203.85V272.026c0-5.633-4.567-10.199-10.199-10.199h-51.617v-76.09h54.301
			c5.632,0,10.199-4.566,10.199-10.199V115.67c0-0.585-0.05-1.17-0.15-1.747c-1.075-6.175-4.918-38.365,24.95-65.847c27.915-25.681,63.439-27.677,73.661-27.677c1.433,0,2.286,0.038,2.442,0.046c0.168,0.008,0.336,0.012,0.504,0.012h62.026v70.428h-44.385c-21.854,0-34.901,12.508-34.901,33.458v51.196C290.681,181.173,295.249,185.739,300.881,185.739z"></path>
                                    <path
                                        d="M224.382,343.713c-5.632,0-10.199,4.566-10.199,10.199v5.1c0,5.633,4.567,10.199,10.199,10.199c5.632,0,10.199-4.566,10.199-10.199v-5.1C234.581,348.279,230.013,343.713,224.382,343.713z"></path>
                                    <path
                                        d="M224.382,381.45c-5.632,0-10.199,4.566-10.199,10.199v77.514c0,5.633,4.567,10.199,10.199,10.199c5.632,0,10.199-4.566,10.199-10.199v-77.514C234.581,386.016,230.013,381.45,224.382,381.45z"></path>
                                </svg>
                            </a>
                            <a href="#" className="footer_a">
                                <svg version="1.1" className="footer_a_img footer_a_img-top"
                                     xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                     viewBox="0 0 511.998 511.998" style={{enableBackground: "new 0 0 511.998 511.998"}}
                                     xmlSpace="preserve">
			...
			c1.546,0,3.117-0.353,4.592-1.098C74.908,180.796,76.923,174.662,74.382,169.635z"></path>
                                    <path
                                        d="M138.353,275.441c-16.724-22.659-32.37-47.27-47.83-75.239c-2.725-4.93-8.931-6.716-13.86-3.992c-4.929,2.725-6.717,8.931-3.992,13.86c15.896,28.756,32.013,54.102,49.271,77.485c2,2.71,5.087,4.143,8.214,4.143c2.104,0,4.226-0.648,6.048-1.995C140.735,286.359,141.697,279.974,138.353,275.441z"></path>
                                </svg>
                            </a>
                        </div>
                        <div className="col-lg-3 col-md-3">
                            <p className="footer_h">Полиция качества</p>
                            <p className="footer_p">Поделитесь с нами отзывом !
                                Ваше мнение важно для нас !
                                Помогите нам стать лучше !
                            </p>
                            <button  className="btn btn-warning btn-footer">Написать</button>
                            <p className="footer_p">Разработано ITPolice</p>
                        </div>
                    </div>
                </div>
                <p className="footer-bottom">Пури Да Хачапури 2019</p>
            </footer>
