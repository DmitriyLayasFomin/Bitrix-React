...
class SliderProductsItem extends React.Component {

    constructor(props) {
        super(props);
        this.props.oldPrice === "" ? this.oldPrice = "" : this.oldPrice =
    ...
    render() {
        return (
            ...
            <div className="slider-product_div">
                            ...
                            <span className="input-group-btn">
					           <button onClick={() => {
                                ...
                                <input type="text" className="form-control text-center"
                                       value={this.state.count} onChange={()=>{void 0;}}
                                />
                                <span className="input-group-btn">
					           <button onClick={() => {
                                   this.props.inCard === true ? this.removeAndChangeCount(1) : this.changeLocalCount(1)
